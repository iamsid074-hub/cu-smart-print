...
export default function TermsAndConditions() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#0f0f10", color: "#e0e0e0" }}
    >
      {/* Header */}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm mt-1" style={{ color: "#666" }}>
                CU Bazaar â€” Last updated: March 3, 2026
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "#888" }}
            >
              CU Bazaar operates as an intermediary under IT Act, 2000. We are
              NOT the seller â€” transactions occur directly between users.
            </p>
          </div>
        </div>
        <div
          className="flex gap-3 p-4 rounded-xl"
          style={{ backgroundColor: "#1a150a", border: "1px solid #2a1e0a" }}
        >
          <AlertTriangle
            className="w-4 h-4 flex-shrink-0 mt-0.5"
            style={{ color: "#F0C040" }}
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "#888" }}
            >
              Our liability is strictly limited to delivery services only. Users
              are responsible for the legality and quality of their own
              transactions.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-3xl mx-auto px-4 pb-20 space-y-1.5">
        {sections.map((s) => (
          ...
          >
            <button
              ...
              style={{
                backgroundColor: openSection === s.id ? "#161618" : "#0f0f10",
              }}
            >
              <span
                className="text-sm font-medium"
                style={{ color: openSection === s.id ? "#e0e0e0" : "#aaa" }}
              >
                <span
                  style={{
                    color: "#555",
              ...
              <ChevronRight
                ...
                style={{
                  color: "#555",
                  transform:
                    openSection === s.id ? "rotate(90deg)" : "rotate(0)",
                }}
              />
            </button>
            {openSection === s.id && (
        ...
        <div
          ...
          style={{ backgroundColor: "#161618", border: "1px solid #1e1e21" }}
        >
          <p className="text-xs leading-relaxed" style={{ color: "#777" }}>
            <strong style={{ color: "#aaa" }}>Acknowledgment:</strong> By using
            CU Bazaar, you confirm that you have read and understood these
            Terms, agree to be bound by them, understand we are an intermediary
            platform only, and will comply with all applicable laws and
            university policies.
          </p>
          <p className="text-[10px] mt-3" style={{ color: "#444" }}>
            <strong>
              By clicking "I Accept" or by using CU Bazzar, you acknowledge that
