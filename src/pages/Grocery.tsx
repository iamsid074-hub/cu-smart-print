      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-20">
        ...
        {!searchQuery && (
          <section className="mb-4">
            ...
            <div
              className="flex overflow-x-auto gap-3 -mx-4 px-4 pb-10 hide-scroll"
          ...
          <section className="mb-4">
            ...
            >
              {groceryItems
                .filter(
                  (item) =>
                    item.category === "Instant Food" ||
                    item.category === "Snacks" ||
                    item.category === "Bakery Snack"
                )
                .map((item, idx) => (
                  <GroceryProductCard
                    key={item.id}
            ...
            {filteredItems.map((item, idx) => (
              ...
              >
                <div className="relative h-32 sm:h-40 bg-slate-50 overflow-hidden">
                  ...
                  />
                  {item.category === "Milk" && (
                    <span className="absolute top-3 left-3 px-2 py-0.5 rounded-full bg-blue-500 text-white text-[9px] font-black uppercase tracking-widest">
                      Fresh
                    </span>
                  )}
                </div>
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <h3 className="text-sm font-bold text-slate-800 leading-tight mb-1 line-clamp-2">
                    {item.name}
                  </h3>
