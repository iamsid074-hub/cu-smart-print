...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white bg-[url('/mobile-wallpaper-red-new.png')] md:bg-[url('/eos-v3-wallpaper-desktop.png')] bg-cover bg-center bg-no-repeat bg-fixed relative overflow-hidden">
