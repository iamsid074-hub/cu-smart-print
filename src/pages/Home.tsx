...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white bg-[url('/eos-v3-wallpaper-mobile.png')] md:bg-[url('/mobile-wallpaper-red-new.png')] bg-cover bg-center bg-no-repeat bg-fixed relative overflow-hidden">
