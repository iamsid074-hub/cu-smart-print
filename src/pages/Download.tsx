...
const INSTALL_STEPS = [
  {
    ...
    desc: "Tap the Download button below to get the latest APK file.",
  },
  {
    icon: "2",
    title: "Allow Unknown Sources",
    desc: `Go to Settings {"\u2192"} Security {"\u2192"} Enable 'Install Unknown Apps' for your browser/files app.`,
  },
  {
    icon: "3",
    title: "Open the APK",
    desc: "Find the downloaded file in your notification bar or Files app and tap to install.",
  },
  {
    icon: "4",
    title: "Install & Launch",
    desc: "Follow the Android install prompt. Once done, open CU Bazzar and log in!",
  },
];
...
export default function Download() {
  ...
  const apkUrl =
    ...
    "https://github.com/iamsid074-hub/cu-smart-print/raw/main/public/cubazzar.apk";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col">
      ...
      <div className="flex-1 px-4 pb-16 max-w-lg mx-auto w-full">
          ...
          >
            {downloading ? (
              ...
              <>
                ...
                {versionData ? `v${versionData.versionName}` : "Latest"})
              </>
            )}
          </div>
        </motion.a>
        ...
        >
          ...
          <span>
            Safe {"\u0026"} secure {"\u00B7"} Free to download {"\u00B7"} No
            Play Store required
          </span>
        </motion.div>
        ...
        <div className="mt-8 text-center">
          ...
          <Link
            to="/"
            className="text-brand-light text-xs font-bold mt-1 block hover:text-white transition-colors"
          >
            Back to Website {"\u2192"}
          </Link>
        </div>
