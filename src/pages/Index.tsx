...
export default function Index() {
  ...
  return (
    <div className="relative overflow-x-hidden min-h-screen selection:bg-white selection:text-[#231942]"
      style={{ backgroundColor: '#0F0A1E' }}>

      {/* â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
          HERO SECTION â€” Apple Product Style
         â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â” */}
      <section ref={heroRef} className="relative min-h-[95vh] flex flex-col items-center justify-center overflow-hidden pt-20"
        style={{ background: 'radial-gradient(ellipse at 60% 40%, #3B1F6A 0%, #231942 40%, #0F0A1E 100%)' }}>
        ...
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden flex items-center justify-center">
          <motion.div 
            ...
            style={{ background: 'radial-gradient(circle, #9B59B6, transparent 70%)', transformOrigin: '38% 38%' }}
          />
          <motion.div 
            ...
            style={{ background: 'radial-gradient(circle, #FF6B6B, transparent 70%)', transformOrigin: '65% 65%' }}
          />
          <motion.div 
            animate={{ rotate: 180, scale: [1, 1.1, 1] }} 
            transition={{ duration: 35, repeat: Infinity, ease: "linear" }}
            className="absolute w-[400px] h-[400px] rounded-full blur-[100px] opacity-25"
            style={{ background: 'radial-gradient(circle, #4DB8AC, transparent 70%)', transformOrigin: '50% 20%' }}
          />
        </div>
        ...
        >
            ...
            <span className="text-[11px] font-bold tracking-tight text-white/90">CU BAZZAR</span>
        </motion.div>
        ...
        >
          {showContent && (
            ...
            >
              <p className="text-[12px] uppercase tracking-widest font-bold" style={{ color: 'rgba(255,255,255,0.45)' }}>
          ...
          {showContent && (
            <motion.p
              className="text-lg sm:text-2xl max-w-2xl leading-snug mb-10 font-medium tracking-tight" style={{ color: 'rgba(255,255,255,0.65)' }}
          ...
          {showContent && (
            ...
            >
              <Link to="/login">
                <button className="px-8 py-3.5 text-[15px] font-semibold tracking-tight shadow-xl flex items-center gap-2 rounded-full text-white transition-all hover:scale-105 active:scale-95"
                  style={{ background: 'linear-gradient(135deg, #9B59B6, #7D3C98)', boxShadow: '0 8px 32px rgba(155,89,182,0.45)' }}>
                  Enter Marketplace
                </button>
              </Link>
              <Link to="/login">
                <button className="text-[15px] font-semibold tracking-tight hover:underline flex items-center gap-1" style={{ color: 'rgba(255,255,255,0.7)' }}>
        ...
        {showContent && (
          ...
          >
            <div className="w-8 h-12 rounded-full flex justify-center p-1.5 shadow-sm"
      ...
      {/* â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
          FEATURES BENTO GRID â€” Glass Cards
         â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â” */}
      <section className="py-24 px-4 sm:px-6 max-w-6xl mx-auto relative z-10" style={{ background: 'transparent' }}>
        <motion.div
        ...
        >
          <h2 className="text-4xl sm:text-6xl font-bold tracking-tighter mb-4" style={{ color: 'rgba(255,255,255,0.95)' }}>
            Pro features.<br/>Standard.
          </h2>
          <p className="text-xl tracking-tight" style={{ color: 'rgba(255,255,255,0.45)' }}>Everything you need, beautifully designed.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {features.map((f, i) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold tracking-tight mb-3" style={{ color: 'rgba(255,255,255,0.95)' }}>
                {f.title}
              </h3>
        ...
        >
          ...
          {stats.map((s, i) => (
            <div key={s.label} className="relative z-10">
              <p className="font-bold text-5xl sm:text-6xl tracking-tighter mb-1" style={{ color: 'rgba(255,255,255,0.95)' }}>
                <Counter target={s.value} suffix={s.suffix} />
              </p>
              <p className="text-[13px] font-semibold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.4)' }}>
                {s.label}
              </p>
            </div>
          ))}
      ...
      <section className="py-32 px-6 relative overflow-hidden flex justify-center">
        ...
        >
          ...
          <p className="text-[17px] leading-relaxed mb-10 max-w-md mx-auto font-medium" style={{ color: 'rgba(255,255,255,0.55)' }}>
            Join hundreds of Chandigarh University students already trading on CU Bazzar.
          </p>

          <Link to="/login">
            <button className="px-10 py-4 text-[17px] font-semibold tracking-tight rounded-full text-white transition-all hover:scale-105 active:scale-95"
              style={{ background: 'linear-gradient(135deg, #9B59B6, #7D3C98)', boxShadow: '0 8px 32px rgba(155,89,182,0.45)' }}>
      ...
      <footer className="py-12 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-8">
            <Link to="/terms" className="text-[13px] font-medium hover:underline" style={{ color: 'rgba(255,255,255,0.5)' }}>
              Terms
            </Link>
            <Link to="/" className="text-[13px] font-medium hover:underline" style={{ color: 'rgba(255,255,255,0.5)' }}>
              Privacy Policy
            </Link>
          </div>
        </div>
