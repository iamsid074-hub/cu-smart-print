    ...
    if (tokenHash && type === "recovery") {
      ...
      supabase.auth
        ...
        .then(({ error }) => {
          if (error) {
            toast.error(
              "Invalid or expired reset link. Try requesting a new one."
            );
          } else {
      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          <p
            ...
            style={{ color: "rgba(232,222,212,0.35)" }}
          >
        ...
        {done ? (
          <div className="text-center space-y-4">
            <CheckCircle
              ...
              style={{ color: "#4DB8AC" }}
            />
            <p className="font-semibold" style={{ color: "#E8DED4" }}>
              Password updated!
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label
                ...
                style={{ color: "rgba(232,222,212,0.4)" }}
              >
                New password
              </label>
              <div
                className="relative"
                style={{
                  boxShadow: "0 0 0 1px rgba(61,52,44,0.6)",
                  borderRadius: "12px",
                }}
              >
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                  <Lock
                    className="h-4 w-4"
                    style={{ color: "rgba(232,222,212,0.2)" }}
                  />
                </div>
                <input
                  type="password"
