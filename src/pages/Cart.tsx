...
export default function Cart() {
  ...
  return (
    <div className="min-h-screen bg-[url('/mobile-wallpaper-red.png')] bg-cover bg-center bg-fixed md:bg-[url('/eos-v3-wallpaper-desktop.png')] md:bg-cover md:bg-center md:bg-fixed text-slate-900 pb-32 md:pb-12 px-4 sm:px-6 font-sans relative">
