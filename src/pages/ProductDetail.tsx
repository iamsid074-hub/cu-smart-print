        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            ...
            <div className="absolute top-6 right-6 flex gap-3 z-10">
              <button
                onClick={handleFav}
                className={`w-12 h-12 flex items-center justify-center rounded-full shadow-sm transition-all duration-300 ${
                  isFav
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-lg text-slate-900">
                    {product.profiles?.full_name || "Student User"}
                  </p>
                  <p className="text-sm text-brand font-medium">
                    @{product.profiles?.username || "student"}
                  </p>
                ...
                <div className="w-full sm:w-auto flex flex-col sm:flex-row items-center gap-3">
                  ...
                  >
                    <DialogTrigger asChild>
                      <button className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-brand hover:bg-brand text-white font-bold shadow-sm transition-transform flex items-center justify-center gap-2 active:scale-95">
                      ...
                      <div className="mt-4 flex flex-col gap-6">
                        ...
                        <div className="flex items-center gap-4 p-5 rounded-3xl bg-slate-50/80">
                          ...
                          <div className="flex-1">
                            <p className="font-bold line-clamp-1 text-slate-900">
                              {product.title}
                            </p>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <input
                              ...
                              maxLength={10}
                              className={`w-full bg-slate-50 rounded-2xl px-5 py-4 text-sm text-slate-900 focus:outline-none focus:ring-4 transition-all placeholder:text-slate-400 ${
