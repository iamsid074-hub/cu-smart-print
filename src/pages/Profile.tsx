...
import { LogOut, User, MapPin, Phone, Package, Heart, Edit2, Check, Loader2, Camera, ShoppingCart, CheckCircle, XCircle, Clock, Bell, Plus, Trash2, Tag } from "lucide-react";
            ...
            <div className="max-w-2xl mx-auto px-4">
                ...
                <div className="py-6 border-b" style={{ borderColor: '#1e1e21' }}>
                    <div className="flex items-center gap-4">
                        {/* Avatar */}
                        <div className="relative flex-shrink-0 cursor-pointer group" onClick={() => isEditing && fileInputRef.current?.click()}>
                            <div className="w-14 h-14 rounded-full overflow-hidden" style={{ backgroundColor: '#1a1a1d', border: '1px solid #2a2a2e' }}>
                                {profile?.avatar_url ? (
