  ...
  return (
    ...
    >
        ...
        {showIntro && (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              >
                <h2
                  className="text-4xl md:text-5xl font-black italic tracking-tighter text-white drop-shadow-2xl"
                  style={fontH}
                >
                  CU BAZZAR
                </h2>
      ...
      >
        {/* Soft gradient orbs */}
        <div
          className="absolute top-[-8%] left-[-5%] w-[450px] h-[450px] rounded-full blur-[100px] animate-pulse pointer-events-none"
          style={{
        ...
        />
        <div
          className="absolute bottom-[-12%] right-[-8%] w-[500px] h-[500px] rounded-full blur-[120px] animate-pulse pointer-events-none"
          style={{
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 1px 1px, rgba(232,222,212,0.8) 0.5px, transparent 0)",
        ...
        >
          ...
          <div className="mb-10">
            ...
            <h1
              className="text-[2.8rem] leading-[1.12] font-bold tracking-tight mb-5"
              style={{ ...fontH, color: "#E8DED4" }}
            >
              Your campus,
              <br />
            ...
            <p
              ...
              style={{
                color: "rgba(232,222,212,0.4)",
                letterSpacing: "-0.01em",
              }}
            >
              The place where CU students trade, discover, and connect. No
              middlemen, just us.
            </p>
          </div>
            ...
            {features.map((f, i) => (
              ...
              >
                ...
                <span
                  ...
                  style={{ color: "rgba(232,222,212,0.5)" }}
                >
                  {f.text}
                </span>
              </motion.div>
            ...
            <div className="flex -space-x-2.5">
              {["#FF6B6B", "#4DB8AC", "#9B59B6", "#F0C040"].map((bg, i) => (
                <div
                  ...
                  style={{ background: bg, border: "2px solid #140F0D" }}
                >
      ...
      <div className="flex-1 flex items-center justify-center px-5 py-10 sm:px-8 lg:px-14 relative min-h-screen lg:min-h-0 bg-[#F5F5F7]">
        {/* Mobile glow */}
        <div
          className="lg:hidden absolute top-0 right-0 w-52 h-52 rounded-full blur-[80px] pointer-events-none"
          style={{ background: "rgba(0,122,255,0.08)" }}
        />
        <div
          className="lg:hidden absolute bottom-0 left-0 w-52 h-52 rounded-full blur-[80px] pointer-events-none"
          style={{ background: "rgba(77,184,172,0.05)" }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent, rgba(15,23,42,0.06), transparent)",
          }}
        />
          ...
          <div className="mb-6">
            <AnimatePresence mode="wait">
              {forgotPassword ? (
                ...
                >
                  <p
                    className="text-sm mb-1.5 font-medium flex items-center gap-2"
                    style={{ color: "#64748B" }}
                  >
                    <Lock className="w-3.5 h-3.5" /> Secure Recovery
                  </p>
                  <h2
                    className="text-2xl sm:text-[1.75rem] font-bold tracking-tight"
                    style={{ ...fontH, color: "#0F172A" }}
                  >
                    Reset your password
                  </h2>
                ...
                >
                  ...
                  >
                    {isLogin
                      ...
                      : "Join hundreds of students on CU Bazzar."}
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            {forgotPassword ? (
                ...
                {resetSent ? (
                  <div className="py-6 text-center space-y-3">
                    <div
                      ...
                      style={{
                        backgroundColor: "rgba(77,184,172,0.12)",
                        border: "1px solid rgba(77,184,172,0.2)",
                      }}
                    >
                  ...
                  <form onSubmit={handleForgotPassword} className="space-y-4">
                    ...
                    <motion.button
                      ...
                      className="w-full py-3.5 rounded-full ios-action-button text-white font-semibold text-[15px] flex items-center justify-center gap-2 h-[52px] disabled:opacity-50"
              ...
              >
                ...
                <div className="relative flex items-center justify-center mb-6">
                  ...
                  <span className="relative px-3 bg-[#F5F5F7] text-[11px] font-semibold text-[#8E8E93] tracking-widest uppercase">
                    or use email
                  </span>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div
                      ...
                      style={{
                        boxShadow:
                          focusedField === "email"
                            ? "0 0 0 2px rgba(0,122,255,0.35), 0 0 16px rgba(0,122,255,0.08)"
                            : "0 0 0 1px rgba(0,0,0,0.05)",
                      }}
                    >
                      <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                      ...
                      <input
                        ...
                        onBlur={() => setFocusedField(null)}
                        className="w-full rounded-[1.2rem] pl-10 pr-4 h-[52px] text-[15px] focus:outline-none transition-colors"
                        style={{
                          backgroundColor: "rgba(255,255,255,0.8)",
                          color: "#1D1D1F",
                        }}
                  ...
                  {!isLogin && (
                    <div className="flex items-start gap-3 px-1">
                      ...
                      >
                        ...
                        of CU Bazzar. I understand it is an intermediary
                        platform and I am responsible for my own transactions.
                      </p>
                    </div>
                  )}
                  ...
                  <motion.button
                    ...
                    whileHover={{ y: -1 }}
                    whileTap={{ scale: 0.985 }}
                    className="w-full relative group py-3.5 rounded-full ios-action-button text-white font-semibold text-[15px] overflow-hidden transition-shadow duration-300 disabled:opacity-50 disabled:cursor-not-allowed h-[52px] mt-2"
                    style={{
                      ...fontH,
                      background: "#1D1D1F",
