...
export default function UsernameSetup({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        if (error.code === "23505") {
          // Unique violation Postgres error code
          setStatus("taken");
          throw new Error(
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground mb-8 text-sm">
            Before diving into the marketplace, pick a unique username for
            others to find and chat with you.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              ...
              whileHover={
                status === "available" && !isSubmitting ? { scale: 1.02 } : {}
              }
              whileTap={
                status === "available" && !isSubmitting ? { scale: 0.98 } : {}
              }
