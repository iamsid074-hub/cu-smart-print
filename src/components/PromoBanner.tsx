        ...
        <div className="w-full relative overflow-hidden group">
            ...
            <Link to="/food" className="hidden sm:block relative w-full h-[300px] md:h-[400px] lg:h-[500px] overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
                ...
                <div
                    ...
                    style={{ backgroundImage: 'url(/banners/ind-nz-desktop.png)' }}
                />
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 z-10">
                    ...
                    >
                        ...
                        <span className="text-xs font-bold text-[#F0C040] italic px-1">VS</span>
                        <div className="flex items-center gap-2">
                            <span className="text-sm font-bold text-white tracking-wide">NZ</span>
                            <span className="text-xl leading-none">🇳🇿</span>
                        </div>
                    ...
                    >
                        <h2 className="text-white text-5xl md:text-7xl lg:text-8xl font-black italic tracking-tighter uppercase leading-none drop-shadow-[0_0_30px_rgba(34,211,238,0.4)]" style={fontH}>
                            ₹14 Delivery <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F0C040] to-orange-500">Today</span>
                        </h2>
                        <p className="text-white/90 text-sm md:text-lg lg:text-xl font-bold mt-2 md:mt-4 max-w-2xl bg-[#0D0907]/50 px-6 py-2 rounded-full backdrop-blur-md">
                            Order now and enjoy match-day snacks delivered fast.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                <p className="text-xl font-black text-cyan-400 tracking-widest font-mono">FINAL14</p>
                            </div>
            ...
            <Link to="/food" className="sm:hidden block relative w-full aspect-[4/5] overflow-hidden rounded-[2rem] shadow-2xl border border-white/10">
                <div
                    ...
                    style={{ backgroundImage: 'url(/banners/ind-nz-mobile.png)' }}
                />
                ...
                <div className="absolute inset-0 flex flex-col p-5 h-full">
                    ...
                    <div className="flex items-center justify-between w-full mt-2">
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full backdrop-blur-md border border-white/20 bg-white/10">
                            <span className="text-sm">🇮🇳</span>
                            <span className="text-[11px] font-bold text-white tracking-wider">IND vs NZ 🇳🇿</span>
                        </div>
                        <div className="px-3 py-1.5 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-[9px] font-bold text-emerald-400 uppercase tracking-widest flex items-center">
                            T20 WC 2026 FINAL
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center w-full pb-2">
                        <h2 className="text-white text-5xl font-black italic uppercase leading-[0.9] drop-shadow-2xl mb-3" style={fontH}>
                            ₹14 Delivery <br />
                            <span className="text-[#F0C040] text-6xl">TODAY!</span>
                        </h2>
                        <p className="text-white/90 text-[11px] sm:text-xs font-bold bg-[#0D0907]/60 px-4 py-2 rounded-full backdrop-blur-md mb-6 border border-white/5">
                            Order now and enjoy match-day snacks delivered fast.
                        </p>
                        ...
                        <p className="text-[10px] text-white/50 mt-3 font-medium uppercase tracking-widest">Apply code FINAL14 in cart</p>
                    </div>
                </div>
            </Link>
        </div>
