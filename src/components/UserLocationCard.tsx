      ...
      <div className="absolute top-[4.5rem] sm:top-[6rem] left-0 right-0 z-[99] pointer-events-none flex justify-center">
        <div className="w-full max-w-[1600px] px-3 lg:px-10">
          <motion.div 
            ...
            style={{
              background: 'linear-gradient(135deg, #7c3aed 0%, #a855f7 30%, #6d28d9 60%, #8b5cf6 100%)',
              boxShadow: '0 8px 32px rgba(124, 58, 237, 0.35), 0 2px 8px rgba(0,0,0,0.1), inset 0 1px 0 rgba(255,255,255,0.15)',
            }}
          >
            {/* Animated glow orbs */}
