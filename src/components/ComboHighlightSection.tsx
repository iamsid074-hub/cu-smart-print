      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-4 px-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-black text-[#1D1D1F] uppercase tracking-wider">
                Top Combos
              </h3>
            ...
            >
              ...
              >
                <div className="relative w-full h-full">
                  <div
                    className={`absolute inset-2 rounded-2xl blur-xl opacity-40 bg-gradient-to-br ${item.theme}`}
                  ></div>
              ...
              <div className="h-32 rounded-3xl bg-gradient-to-br from-[#2A2A2C]/80 to-[#1D1D1F] backdrop-blur-xl border border-white/5 p-4 flex flex-col justify-between shadow-xl">
                <div className="max-w-[160px]">
                  <h4 className="text-sm font-black text-white/95 leading-tight truncate">
                    {item.name}
                  </h4>
