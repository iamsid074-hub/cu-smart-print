...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; pulse: string; icon: typeof Truck }> = {
    ...
    confirmed:        { label: "Accepted — On Hold",  color: "text-purple-600",  bg: "bg-purple-50 border-purple-200",pulse: "bg-purple-400",  icon: Package },
    picked:           { label: "Item Picked Up",      color: "text-orange-600",  bg: "bg-orange-50 border-orange-200",pulse: "bg-orange-400",  icon: Package },
    delivering:       { label: "Out for Delivery 🛵", color: "text-brand",       bg: "bg-brand-50 border-brand-muted",pulse: "bg-brand",       icon: Truck },
    completed:        { label: "Delivered! 🎉",       color: "text-emerald-600", bg: "bg-emerald-50 border-emerald-200",pulse: "bg-emerald-400",icon: CheckCircle },
};
