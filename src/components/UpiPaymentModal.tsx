                        ...
                        <AnimatePresence mode="wait">
                            {step === "qr" && (
                                ...
                                >
                                    ...
                                    <div className="bg-white p-3 rounded-2xl border-2 border-slate-100 shadow-sm mb-6 w-full max-w-[220px] mx-auto overflow-hidden">
                                        <img src="/payment-qr.webp" alt="Payment QR Code" className="w-full h-auto rounded-xl block" style={{ mixBlendMode: 'multiply' }} />
                                    </div>
                            ...
                            {step === "verifying" && (
                                ...
                                >
                                    ...
                                    <p className="text-lg font-bold text-slate-900">Confirming Payment...</p>
