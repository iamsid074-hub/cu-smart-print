...
export default function CircularColdDrinks() {
  ...
  const drinks = groceryItems
    .filter((i) => i.category === "Cold Drinks")
    .slice(0, 8);
  ...
  return (
    <section className="mb-14 py-6 relative w-full overflow-hidden flex flex-col items-center">
      ...
      >
        ...
        >
          <h2
            className="text-base sm:text-xl font-black text-slate-800 tracking-tight text-center leading-tight px-3"
            ...
            >
              ...
              >
                ...
                <div className="mt-7 sm:mt-10 flex flex-col items-center w-full gap-1.5">
                  <h3 className="text-[8px] sm:text-[10px] font-bold text-slate-800 text-center leading-[1.2] line-clamp-2 tracking-tight w-full">
                    {item.name}
                  </h3>
