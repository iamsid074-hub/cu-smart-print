      ...
      >
        ...
        >
          ...
          <div className="relative bg-white/30 rounded-[18px]">
            ...
            <Link
              to="/pasta-offer"
              className="flex items-center gap-3 p-3 pr-5"
            >
              {/* Mini pasta image */}
              <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 bg-white shadow-sm border border-black/5">
                <img
                  src="/banners/red_sauce_pasta.png"
                  alt="Pasta"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="flex flex-col min-w-0 pr-2">
                <span className="text-[10px] font-bold text-[#FF3B30] uppercase tracking-wider mb-0.5">
                  Limited Offer
                </span>
                <span className="text-[15px] font-bold text-[#1D1D1F] leading-tight tracking-tight">
                  Pasta @ {"₹"}99
                </span>
