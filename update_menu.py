...
file_path = 'c:/Users/A/OneDrive/Desktop/BAZZAR/src/config/shopMenus.ts'
...
new_lines = []
inside_chatori1 = False
inside_chatori2 = False
i = 0

while i < len(lines):
    line = lines[i]
    if 'id: "chatori-chai-kulcha"' in line:
        inside_chatori1 = True
    if 'id: "chatori-chaat"' in line:
        inside_chatori2 = True
    
    if (inside_chatori1 or inside_chatori2) and 'categories: [' in line:
...
print("SUCCESSFULLY UPDATED SHOPMENUS.TS")
